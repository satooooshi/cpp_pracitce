...
void Calc::calc()
{
    ...
    //int b[N] = {58345678,40123456,18901234,96789012,84567890};
    int a[N]={00000000,00000000,00000000,00000000,999999};
    int b[N] = {      0,0,0,0,111};
    int c[N] = {58345678,40123456,18901234,96789012,84567890};
    int d    = 99;
